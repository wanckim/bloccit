class SponsoredPostsController < ApplicationController
  ...
  def create
    ...
    if @sponsored_post.save
      flash[:notice] = "Sponsored post has saved successfully."
  ...
  def update
    ...
    if @sponsored_post.save
      ...
      flash.now[:alert] = "There was an errer updating the sponsored post. Please try again."
      render :edit
    end
  end
  ...
  def destroy
    ...
    if @sponsored_post.delete
      ...
      flash.now[:alert] = "There was an error deleting sponsored post."
      render :show
    end
  end
end
