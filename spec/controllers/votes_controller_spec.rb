...
RSpec.describe VotesController, type: :controller do
  ...
  context "signed in user" do
    ...
    describe "POST up_vote" do
      it "the user's first vote increases number of post votes by 1" do
      ...
      it "the user's second vote does not increase number of post votes" do
        post :up_vote, params: {post_id: user_post.id}
        votes = user_post.votes.count
        post :up_vote, params: {post_id: user_post.id}
      ...
      it ":back redirects to post's show page" do
        request.env["HTTP_REFERER"] = topic_post_path(my_topic, user_post)
        post :up_vote, params: {post_id: user_post.id}
      ...
      it ":back redirects to post's topic show" do
    ...
    describe "POST down_vote" do
      ...
      it "decrease the sum of post votes by 1" do
        points = user_post.points
        post :down_vote, params: {post_id: user_post.id}
