...
RSpec.describe TopicsController, type: :controller do
  ...
  context "member user" do
    before do
      user = User.create!(name: "Bloccit User", email: "user@bliccit.com", password: "password", role: :member)
      create_session(user)
    end
  ...
  context "moderator user" do
    before do
      moderator_user = User.create!(name: "Bloccit User", email: "user@bliccit.com", password: "password", role: :moderator)
    ...
    describe "PUT update" do
      it "update topics with expected attributes" do
        new_name = RandomData.random_sentence
        new_description = RandomData.random_paragraph
